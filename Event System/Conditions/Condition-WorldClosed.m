...
#import "Condition-WorldClosed.h"
#import "AtlantisState.h"

@implementation Condition_WorldClosed
...
{
    // TODO: Localize
    return @"World: Has Just Been Closed";
}

+ (NSString *) conditionDescription
{
    // TODO: Localize
    return @"The world has just been closed.";
}
...
- (BOOL) isTrueForState:(AtlantisState *) state
{
    ...
    if (statechange)
        if ([statechange caseInsensitiveCompare:@"closed"] == NSOrderedSame)
            return YES;
